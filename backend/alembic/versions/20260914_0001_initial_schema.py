"""Initial schema aligned with docs/mysql/ddl_v1.sql.

Revision ID: 20260914_0001
Revises:
Create Date: 2026-09-14

New environments: ``alembic upgrade head`` then apply ``docs/mysql/seed_v1.sql``.
Existing databases created from DDL: ``alembic stamp 20260914_0001`` (or ``stamp head``
after applying later revisions), do not re-run this upgrade.
"""

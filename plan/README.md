...
../docs/*（DDL / API / SSE）
        ↓
M1 总结 / Bugs → … → **M6 一期收口（已完成）** → [交接说明](./phase1-handoff.md) → **M7 系统管理 / RBAC（已完成）**
```
...
| [milestone-M7-next-goals.md](./milestone-M7-next-goals.md) | M7 目标与 DoD（已达成） |
| [milestone-M7-completion.md](./milestone-M7-completion.md) | **M7 完成说明（验收通过）— 系统管理 / RBAC** |
